...
export function numFramesInThisModule() {
    try {
        ...
        const frames = stackTraceParser.parse(ex.stack);
...
export function adorn(msg, ...moreMsg) {
    ...
    try {
        ...
        let lineNo = callingFrame.lineNumber;
        let callFile = callingFrame.file;
